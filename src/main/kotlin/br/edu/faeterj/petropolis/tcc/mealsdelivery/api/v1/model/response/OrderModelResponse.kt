...
data class OrderModelResponse(
    ...
    @ApiModelProperty(example = "2022-07-14T11:35:10Z")
    var confirmationDate: OffsetDateTime? = null,

    @ApiModelProperty(example = "2022-07-14T11:35:00Z")
    var cancellationDate: OffsetDateTime? = null,

    @ApiModelProperty(example = "2022-07-14T11:55:30Z")
    ...
    var paymentMethod: PaymentMethodModelResponse,

    var deliveryAddress: AddressModelResponse,

    var items: List<OrderItemModelResponse>

) : RepresentationModel<OrderModelResponse>()